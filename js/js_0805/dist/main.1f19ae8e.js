  ...
  _getData = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = $(_templateObject || (_templateObject = _taggedTemplateLiteral(["{API_KEY}"])));
          _context.next = 3;
          return fetch(url);
        case 3:
...
function drawMap(locations) {
  ...
  locations.forEach(function (location, i) {
    ...
    markerElement.addListener("click", function () {
      infowindow.setContent("<div><strong>".concat(location[0], "</strong><br/>Bikes available: ").concat(location[3], "</div>"));
